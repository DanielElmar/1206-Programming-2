...
public class GameWindow {
    ...
    public GameWindow(Stage stage, int width, int height) {
        ...
        //Setup window (height, Title and closing operations)
        setupStage();

        //Setup resources (Loads reaousrces including fonts and anything else we need)
        setupResources();

        //Setup default scene (creates a black scence)
        setupDefaultScene();
    ...
    public void startMultiplayerChallenge( Communicator communicator, String myName ) {
        loadScene(new MultiplayerScene(this, communicator, myName)); }
